...
import { formatDate, formatTime, normalizeCurrencyLabel } from "@/lib/utils"
                ...
                .map((payment: any, index: number) => (
                  <div key={payment.id} className={`p-4 rounded-lg space-y-2 text-sm border ${index === 0 ? 'bg-blue-50 border-blue-200 shadow-sm' : 'bg-gray-50'}`}>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <Price value={payment.amount} currency={normalizeCurrencyLabel(payment.currency)} className="font-bold text-lg" />
                    </div>
            ...
            return (
              <div className="space-y-6 py-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <InfoRow icon={<DollarSign className="h-4 w-4 text-emerald-500" />} label="السعر الإجمالي" value={<Price value={Number(b.totalPrice)} />} />
                </div>

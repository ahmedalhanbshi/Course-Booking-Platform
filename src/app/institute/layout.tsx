...
import { InstituteHeader } from "@/components/layout/institute-header"
import { InstituteSidebar } from "@/components/layout/institute-sidebar"
...
export default function InstituteLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100" dir="rtl">
      <InstituteHeader onMenuClick={() => setIsSidebarCollapsed((prev) => !prev)} />
      ...
      <div className="flex min-h-[calc(100vh-4rem)]">
        ...
        >
          <InstituteSidebar collapsed={isSidebarCollapsed} />
        </aside>

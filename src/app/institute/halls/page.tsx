      ...
      {activeTab === "halls" && (
        loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-gray-500">
            <p className="mb-4 text-center">لم يتم إضافة قاعات حتى الآن</p>
            ...
            {halls.map((hall) => (
              <HallCard 
                ...
                hall={{
                  ...
                  image: hall.image || "",
                  owner: "" // Already in management view, owner context clear
                }}
                onSelect={() => handleOpenEdit(hall.id)}
                actionLabel="تعديل القاعة"

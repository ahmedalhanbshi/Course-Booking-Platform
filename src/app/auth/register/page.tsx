  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role === 'TRAINER') {
        ...
        if (formData.specialization) submitData.append('specialties', JSON.stringify([formData.specialization]))
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-top-4 duration-500 border-r-2 border-primary/20 pr-4 my-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="specialization" value={formData.specialization} onChange={e => setFormData({ ...formData, specialization: e.target.value })} placeholder="مثال: تطوير الويب، إدارة أعمال..." className="pr-10" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Textarea id="bio" value={formData.bio} onChange={e => setFormData({ ...formData, bio: e.target.value })} placeholder="تحدث باختصار عن خبراتك ومهاراتك..." className="min-h-[100px]" />
                  </div>
                </div>

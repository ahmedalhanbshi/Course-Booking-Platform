        ...
        >
          ...
          <DialogHeader className="space-y-2 text-right">
            ...
            <DialogDescription className="text-right">
              {selectedCourse ? (
                <>
                  {selectedCourse.title} - <Price value={5000} />
                </>
              ) : (
                <Price value={5000} />
              )}
              ...
              <div className="flex h-full w-full flex-1 flex-col py-1">
                ...
                <div className="mt-auto flex w-full items-end justify-between border-t border-slate-50 pt-4">
                  <div className="flex flex-col gap-2">
                    <Price
                      value={course.price}
                      className="hidden text-xl font-black text-blue-600 sm:inline-flex"
                      currencyClassName="text-[10px] font-bold text-slate-400 tracking-tight"
                    />

...
const heroSlides = [
  {
    src: "/images/vvv/1.png",
    alt: "طلاب في جلسة تعلم",
    position: "50% 42%",
  },
  {
    src: "/images/vvv/2.png",
    alt: "مدرب يشرح محتوى تدريبي",
    position: "50% 38%",
  },
  {
    src: "/images/vvv/3.png",
    alt: "متدرب يطبق خلال الدورة",
    position: "50% 40%",
  },
  {
    src: "/images/vvv/4.png",
    alt: "تدريب حضوري داخل معهد",
    position: "50% 36%",
  },
  {
    src: "/images/vvv/5.png",
    alt: "تعلم أونلاين مرن",
    position: "50% 34%",
  },
];
...
const features = [
  {
    icon: Compass,
    title: "اكتشاف أسرع",
    description: "ابحث عن الدورة المناسبة حسب المجال، المستوى، ونمط التعلم.",
  },
  {
    icon: Layers,
    title: "خيارات مرنة",
...
export default function HomePage() {
  ...
  return (
    <main
      dir="rtl"
      className="relative isolate min-h-screen overflow-x-hidden bg-[#f7f9ff] text-slate-900"
    >
      ...
      {/* Hero */}
      <section className="relative overflow-hidden pb-18 pt-10 lg:pb-22 lg:pt-14">
          ...
          <div className="grid items-center gap-5 lg:grid-cols-[1.08fr_0.92fr] lg:[direction:ltr] lg:gap-5">
            ...
            >
              <motion.div
                ...
                transition={shouldReduceMotion ? undefined : { duration: 7.8, repeat: Infinity, ease: "easeInOut" }}
                className="group relative mx-auto h-[350px] w-[350px] sm:h-[500px] sm:w-[500px] lg:mx-0 lg:h-[660px] lg:w-[660px]"
              >
                <motion.div
                  className="pointer-events-none absolute inset-[11%] -z-10 rounded-full bg-[#3f50e0]/30 blur-[96px]"
                  animate={shouldReduceMotion ? undefined : { opacity: [0.34, 0.58, 0.34], scale: [1, 1.07, 1] }}
                  transition={shouldReduceMotion ? undefined : { duration: 12, repeat: Infinity, ease: "easeInOut" }}
                />

                <div
                  className="pointer-events-none absolute inset-0 animate-soft-glow bg-[#4c5af0]/22 blur-[84px] motion-reduce:animate-none"
                  style={logoMaskStyle}
                />

                <div className="absolute inset-0 transition-transform duration-500 group-hover:scale-[1.012] motion-reduce:transform-none">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <Image
                        ...
                        style={{ objectPosition: heroSlides[activeHeroSlide].position }}
                        priority
                      />
                    </motion.div>
                  </AnimatePresence>
                  ...
                  <div
                    className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#1d4ed8]/35 via-transparent to-[#6366f1]/25"
                    style={logoMaskStyle}
                  />
                  <div
                    className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.24),transparent_46%),radial-gradient(circle_at_70%_82%,rgba(79,70,229,0.24),transparent_56%)]"
                    style={logoMaskStyle}
                  />
                </div>
              </motion.div>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="mt-2 text-sm font-semibold text-slate-600">
                        {formatEnglishNumber(category._count?.courses ?? 0)} دورات
                      </p>
                    </Link>
                  </motion.div>
                ))
                      ...
                      >
                        <div className="relative h-44 w-full overflow-hidden">
                          <Image
                            ...
                            unoptimized={imageSrc.includes("localhost:5000")}
                          />
                        </div>
